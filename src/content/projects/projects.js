...
const projects = [
  {
    ...
    functionality: "This web app tracks Wins and Losses for different players, as well as providing ranking functionality to rank by Win % and total Wins, entries are editable and the list of players is stored between sessions",
  ...
  },
  {
    ...
    functionality: "This mock B2C web app for 'Dough Joe Pizza' provides a customisable pizza menu, nutrition calculation functionality, a persistent shopping basket, and the ability to review orders made",
  ...
  , {
    ...
    functionality: "This app provides desk booking functionality on a per-day basis, with limits on regular users and additional permissions for admins. The desk layout is visual and interactive to make selection clearer.",
  ...
  },
  {
    ...
    functionality: "A fully Java game, this produces a pop up window in which you can see the game text, input your commands, and have a map of your location on the ship as well as previously explored locations. Player actions can impact accessible areas.",
